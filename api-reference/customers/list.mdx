...
<ParamField query="last_booking_after" type="string">
  Customers with last booking after this date (format: YYYY-MM-DD)
</ParamField>

<ParamField query="last_booking_before" type="string">
  Customers with last booking before this date (format: YYYY-MM-DD)
</ParamField>

<ParamField query="agent_id" type="integer">
  Filter customers who have had appointments with a specific agent
</ParamField>

<ParamField query="service_id" type="integer">
  Filter customers who have used a specific service
</ParamField>

<ParamField query="location_id" type="integer">
  Filter customers who have visited a specific location
</ParamField>
...
<ParamField query="order_by" type="string" default="created_at">
  ...
  **Possible values:**
  ...
  - `last_booking_date` - By last booking date
  - `total_bookings` - By total number of bookings
</ParamField>
