...
<ParamField query="include" type="string">
  ...
  **Possible values:**
  ...
  - `preferences` - Include customer preferences
  - `payment_methods` - Include saved payment methods
</ParamField>
...
<ResponseField name="data" type="object">
  ...
  <Expandable title="Customer Information">
    ...
    <ResponseField name="preferences" type="object">
      Customer preferences (if included)
    ...
    <ResponseField name="payment_methods" type="array">
      Saved payment methods (if included)
    </ResponseField>
  </Expandable>
</ResponseField>
